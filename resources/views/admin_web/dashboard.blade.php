    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                <h3>{{$products_available_count}}</h3>
            ...
            <div class="small-box bg-red">
              <div class="inner">
                <h3>{{$products_unavailable_count}}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-black">
              ...
              <a href="{{route('users_checkout.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
             <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-white">
              ...
              <a href="{{route('shipping.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
...
//-------------
    ...
    var donutData        = {
      ...
      datasets: [
        {
          data: [{{$products_available_count}},{{$cart_orders}},{{$purchased_orders}},{{count($users)}},{{count($users_checkout)}},{{count($shippings)}}, {{count($payments)}}],
