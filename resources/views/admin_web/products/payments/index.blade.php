...
<div class="content-wrapper" style="min-height: 1200.88px;">
  ...
  @if($payments) 	
    ...
    <tr>
      ...
      <td>{{$payment->created_at ? $payment->created_at->diffForHumans() : 'No data'}}</td>
      <td>{{$payment->updated_at ? $payment->updated_at->diffForHumans() : 'No data'}}</td>
      <td>
        {!!Form::open(['method'=>'DELETE' , 'action'=>['AdminPaymentsController@destroy', $payment->id]])!!}
