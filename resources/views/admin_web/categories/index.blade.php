          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="categories" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$category->id}}</td>
                  <td><a style="color:black" href="{{route('categories.edit', $category->id)}}">{{$category->name}}</a></td>
                  ...
                  <td><a style="color:black" href="{{route('categories.edit', $category->id)}}">Edit</a></td>
                  <td>
