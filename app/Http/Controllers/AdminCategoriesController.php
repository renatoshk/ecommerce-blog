...
class AdminCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin_web.categories.index', compact('categories'));
    }
    ...
    public function create()
    {
        //
        $categories = Category::all();
        return view('admin_web.categories.create', compact('categories'));
    ...
    public function edit($id)
    {
        ...
        return view('admin_web.categories.edit', compact('category'));
    }
    ...
    {
        //
        $cat_destroy = Category::findOrFail($id)->delete();
